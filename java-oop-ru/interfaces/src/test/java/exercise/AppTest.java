...
class AppTest {
    ...
    // BEGIN
    @Test
    void testResersedSequenceToString() {
    ...
    @Test
    void testResersedSequenceCharAt() {
        CharSequence text = new ReversedSequence("fedcba");
        char expected = 'e';
    ...
    @Test
    void testResersedSequenceLength() {
        CharSequence text = new ReversedSequence("fedcba");
        int expected = 6;
    ...
    @Test
    void testResersedSequenceSubSequence() {
        CharSequence text = new ReversedSequence("fedcba");
        String expected = "edc";
